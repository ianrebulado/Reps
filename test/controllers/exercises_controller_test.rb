...
class ExercisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercise" do
    assert_difference("Exercise.count") do
      post exercises_url, params: { exercise: { create: @exercise.create, new: @exercise.new, show: @exercise.show } }
    end
  ...
  test "should update exercise" do
    patch exercise_url(@exercise), params: { exercise: { create: @exercise.create, new: @exercise.new, show: @exercise.show } }
